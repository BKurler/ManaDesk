...
public class Format {
	...
	public static final Format PIONEER = new ConstructedFormat("Pioneer", 2);
	...
	/**
	 * @param count - count of the cards to validate
	 */
	...
	/**
	 * @param count sideboard total cards
	 * @return error string or null if legal
	 */

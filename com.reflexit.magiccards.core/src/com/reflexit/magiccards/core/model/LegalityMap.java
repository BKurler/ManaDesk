...
public class LegalityMap {
	...
	// RD Change | to ; to address flat pipe files the easy way
	// While keeping compatibility with old format
	public final static String SEP = ";";
	public final static String OLD_SEP = "|";
	...
	private static class LegalityHashMap extends TreeMap<Format, Legality> {
		...
		private static LegalityHashMap valueOf(String value) {
			...
			String vs[] = null;
			if (value.contains("OLD_SEP")) {
				vs = value.split("\\Q" + OLD_SEP);
			} else {
				vs = value.split("\\Q" + SEP);
			}
	...
	/**
	 * @param value Comma separated list of legal formats
	 * @return
	 */

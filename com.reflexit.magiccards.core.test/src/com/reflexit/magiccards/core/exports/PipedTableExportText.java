...
public class PipedTableExportText extends AbstarctExportTest {
	...
	public void testFull() {
		...
		assertEquals(
				"ID|NAME|COST|TYPE|POWER|TOUGHNESS|ORACLE|SET|RARITY|DBPRICE|LANG|RATING|ARTIST|COLLNUM|RULINGS|TEXT|ENID|GATHERERID|TCGID|PROPERTIES|COUNT|PRICE|COMMENT|LOCATION|CUSTOM|OWNERSHIP|SPECIAL|DATE|CONDITION",
				lines[0]);
		assertEquals(
